...
// Returns the number of hours from in 24-hour format
int get_hours(int seconds);

// Returns the number of minutes from in 24-hour format
int get_minutes(int seconds);

// Returns the number of seconds from in 24-hour format
