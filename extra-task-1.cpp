...
int get_hours(double s)
{
    return (int)(s / 3600);
}

int get_minutes(double s)
{
    return (int)((s - get_hours(s) * 3600) / 60);
}

int get_seconds(double s)
{
    return (int)(s - get_minutes(s) * 60 - get_hours(s) * 3600);
}
...
{
    return to_24_hour_clock(utc_offset + time + 24);
