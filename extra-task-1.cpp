...
int main()
{
    ...
    assert(fabs(time_to_utc(+6, 5.0) - 23.0) < DBL_EPSILON);  //Additional test to check passing to previous day
    ...
    assert(fabs(time_from_utc(-2, 1.0) - 23.0) < DBL_EPSILON);  //Additional test to check passing to previous day
